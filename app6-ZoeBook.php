...
<head>
  ...
  <title data-gatsby-head="true">Portfolio: Mobile App ZoeBook | App pulse</title>
</head>
<?php
          ...
          <div class="undefined relative z-50 ">
            <main>
              <section class="hero-sec pb-0 lg:pb-8">
                    ...
                    <div>
                      <div class="overflow-hidden">
                        <h1
                          ...
                          ZoeBook – Your Gateway to Virality and Authentic Connections.</h1>
                      </div>
                ...
                src="./dist/images/portfolio/06.jpg"
                loading="lazy" class="w-full" alt="ZoeBook App" />
                ...
                <div class="px-6 lg:px-8 pt-14 md:pt-[10.5rem] max-w-7xl mx-auto">
                  <div class="lg:grid lg:grid-cols-12">
                    <div class="lg:col-span-6">
                      ...
                      In the dynamic world of social media, where trends emerge and fade in the blink of an eye, the need for a platform that fosters virality and meaningful engagement has never been greater. Our client envisioned a revolutionary app designed to give users the tools and opportunities to go viral, connect with their audience, and maintain authentic relationships with vital communities. Their mission: to create a social media platform that’s not just about sharing content but about building influence and fostering real connections.<br /><br /></p>
                  ...
                  <div class="flex justify-between flex-wrap">
                    <div class="lg:w-[50%]">
                      <div class="lg:overflow-hidden">
                        <h2
                          class="font-bold pb-6 lg:pb-[2.375rem] sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                          <span>ZoeBook – Go Viral, Stay Connected:</span>
                          <br class="block lg:hidden" /></h2>
                      </div>
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                      ZoeBook reimagines social media by providing users with an exciting, viral-driven platform. Whether you’re sharing photos, telling stories, engaging with friends, or building a thriving community, ZoeBook ensures every interaction counts. With its unique “Go Viral in 48 Hours” promise, users can amplify their reach and influence like never before.</p>
                    </div>
                    ...
                    <div class="lg:col-span-6">
                      <div class="flex flex-col gap-y-5">
                        <div style="background:#F1F1F1"
                          ...
                          Ideation:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          We began by identifying key elements that drive success in social media: virality, engagement, ease of use, and community building. Through in-depth research, we discovered opportunities to differentiate ZoeBook by focusing on rapid content exposure, personalized recommendations, and advanced community tools.</p>
                        </div>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Studying platforms like Instagram and TikTok, we uncovered gaps such as limited viral reach for new users, inconsistent engagement, and a lack of tools to sustain meaningful connections. ZoeBook was designed to overcome these challenges by emphasizing rapid content virality, deeper community connections, and innovative content-sharing features.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <h3 class=" font-bold my-3 text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Design &amp;
                            Development:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          Our design team created a vibrant and intuitive interface to ensure users could navigate seamlessly, whether they’re sharing content or engaging with friends. Development efforts focused on three core areas:</p>
                          <ul class="design-list">
  <li><strong>Content Sharing Tools:</strong> Enabling users to share photos, stories, and viral challenges effortlessly.</li>
  <li><strong>Community Engagement Features: </strong>Supporting the creation of pages, groups, and community events to foster strong relationships.</li>
  <li><strong>Virality Engine:</strong>Leveraging algorithms that maximize content exposure within 48 hours, boosting visibility and engagement.</li>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          We rigorously tested ZoeBook with diverse user groups to ensure functionality and performance. Features like instant notifications, viral tracking analytics, and user-friendly page management were fine-tuned for optimal user satisfaction. Load testing during high traffic scenarios ensured the app could handle virality without interruptions.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          Launch  &amp; Support:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          ZoeBook was successfully launched on iOS and Android, accompanied by a comprehensive marketing campaign to drive initial user adoption. Our dedicated support team provides continuous updates, introduces new features like AI-driven content suggestions, and ensures the platform remains a thriving space for users to go viral and stay connected.</p>
                        </div>
                      </div>
                    </div>
                  </div>
