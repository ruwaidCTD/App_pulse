...
<head>
  ...
  <title data-gatsby-head="true">Portfolio: Mobile App Welcome To Badger | App pulse</title>
</head>
<?php
          ...
          <div class="undefined relative z-40 ">
            <main>
              <section class="hero-sec pb-0 lg:pb-8">
                    ...
                    <div>
                      <div class="overflow-hidden">
                        <h1
                          ...
                          Welcome To Badger - Your Personal Task Reminder</h1>
                      </div>
                ...
                src="./dist/images/portfolio/04.jpg"
                loading="lazy" class="w-full" alt="Welcome To Badger App" />
                ...
                <div class="px-6 lg:px-8 pt-14 md:pt-[10.5rem] max-w-7xl mx-auto">
                  <div class="lg:grid lg:grid-cols-12">
                    <div class="lg:col-span-6">
                      ...
                      In a world brimming with distractions, staying organized is no small feat. Our client recognized the growing need for a digital assistant that not only keeps users on track but also empowers them to achieve their daily goals seamlessly. Their vision was to create a task reminder app that simplifies task management while fostering productivity, ensuring users never miss a beat in their busy lives.<br /><br /></p>
                  ...
                  <div class="flex justify-between flex-wrap">
                    <div class="lg:w-[50%]">
                      <div class="lg:overflow-hidden">
                        <h2
                          class="font-bold pb-6 lg:pb-[2.375rem] sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                          <span>Welcome To Badger – Stay Ahead, Stay Accomplished:  </span>
                          <br class="block lg:hidden" /></h2>
                      </div>
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                      Welcome To Badger transforms the way users approach daily tasks by offering a reliable and intuitive platform for task reminders. Whether it’s remembering to wash your car, schedule study time, or set up recurring alarms, Badger ensures you stay on top of your priorities with ease and efficiency.</p>
                    </div>
                    ...
                    <div class="lg:col-span-6">
                      <div class="flex flex-col gap-y-5">
                        <div style="background:#F1F1F1"
                          ...
                          Ideation:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          We initiated the project by diving into what users seek in a task reminder app: simplicity, reliability, and customization. Through extensive user research, we identified opportunities to enhance productivity by integrating features like intuitive scheduling, recurring task reminders, and personalized notifications.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          To refine our approach, we studied leading apps like Google Tasks and To-do-List. While these platforms excel at task management, users often faced challenges like overwhelming interfaces and limited customization options. This inspired us to position Welcome To Badger as a user-centric solution that prioritizes simplicity, functionality, and personalization.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Our design and development teams worked collaboratively to create a sleek, intuitive interface that ensures effortless navigation. Key features include: </p>
                          <ul class="design-list">
  <li><strong>Task Scheduling:</strong> Enabling users to set tasks with specific dates, times, and priority levels. </li>
  <li><strong>Recurring Reminders: </strong> Supporting daily, weekly, or custom interval reminders for regular tasks. </li>
  <li><strong>Smart Notifications: </strong>Smart Notifications: Delivering timely reminders with motivational messages to keep users on track. </li>
  <li><strong>Customization: </strong>Customization: Allowing users to categorize tasks, assign colors, and add notes for better organization.</li>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          We rigorously tested Welcome To Badger across diverse devices and environments to ensure flawless performance. Usability testing with real users provided valuable feedback, helping us refine features and address pain points. Peak-hour stress tests and system reliability assessments ensured the app’s robustness.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          Launch  &amp; Support:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          With the client’s approval, Welcome To Badger was launched on both iOS and Android platforms. Post-launch, our support team actively monitors app performance, gathers user feedback, and rolls out updates, introducing features like AI-based task suggestions and enhanced notification customization to continually enhance user satisfaction.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                                ...
                                <div class="mx-auto max-w-7xl px-6 pt-14 md:pt-24 lg:pt-[10.5rem] md:px-8">
                                    <div class="md:flex">
                                        <div class="w-full xl:w-[60%] lg:w-[55%] md:[50%] mr-[5%]">
                                            <div class="lg:overflow-hidden">
                                                <h2 class=" pb-6 font-bold pb-6 lg:pb-[2.375rem] sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                                            ...
                                            <div>
                                                <div class="flex gap-4 items-center my-6"><img
                                                        src="./dist/images/check-white.svg" class="lg:w-[30px] w-[20px]"
                                                        alt="Bullet Point" />
                                                    <ul>
                                                        <li>
                                            ...
                                            <div class="flex mt-12">
                                                <button
                                                    class="open-modal header-module--buttonChange--18e23 open-modal bg-black text-white items-center px-6 md:px-11 h-[40px] md:h-12 border-transparent rounded-full font-extrabold text-sm"><span
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            ...
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Apple</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">AR
                                                                    Kit</span></div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">SwiftUI</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Swift</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">RxSwift</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Health</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Widgets</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Combine</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="block">
                                                        <a
                                                            class="h-[123px] w-full bg-gray-100 md:px-3.5 py-5 border-transparent rounded-xl md:rounded-3xl font-medium md:font-normal text-[12px]  md:text-lg hover:bg-black hover:text-white transition duration-500 md:flex flex-col items-center justify-center gap-2 hover:shadow-lg hover:shadow-slate-400"><img
                                                                ...
                                                                alt="App Pulse Asset" />
                                                            <div class="text-center"><span
                                                                    class="text-sm font-medium leading-tight">Obj
                                                                    C</span></div>
                                                        </a>
                                                    </div>
                                                </div>
              ...
              <div class="undefined bg-dark-theme md:h-[370px] lg:h-[600px] relative bg-cover"
                                ...
                                <div
                                    ...
                                    <div class="2xl:w-7/12 md:w-2/4 w-full 2xl:pr-10">
                                        ...
                                        <button
                                            class="open-modal open-modal header-module--buttonChange--18e23 bg-white text-black items-center px-6 md:px-11 h-[40px] md:h-12 border-transparent rounded-full font-extrabold text-sm"><span
