                                                    ...
                                                    <ul class="splide__list">
                                                        <li class="splide__slide">
                                                            <div class="flex grow shrink-0 flex-col lg:basis-[25rem] mr-16">
                                                                <div class="lg:overflow-hidden">
                                                                    <h2 class="font-bold lg:pb-[2.375rem] pb-6 text-white sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]"><span>building <span class="!normal-case">MVP</span> across use cases.</span></h2>
                                                                </div>
                                                                <p class="text-white text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Our MVP development expertise covers a wide range of use cases, tailored to your specific needs.</p>
                                                            </div>
                                                        </li>
                                                        <li class="splide__slide">
                                                            <article class="relative isolate flex flex-col justify-end overflow-hidden lg:rounded-[30px] rounded-2xl bg-gray-900 lg:px-10 px-6 lg:pb-10 pb-6 pt-48 lg:pt-80 w-full h-full"><a href="../web-development/index.html"><img src="https://images.ctfassets.net/mi665aivb0at/qqtiKQysn9TpnkirWu89X/539bd770e38839699a7843b90b2751ab/Web_Development_.webp" alt="Web Development" class="absolute inset-0 -z-10 h-full w-full object-cover" />
                                                                    <div class="black-overlay"></div>
                                                                    <div class="absolute lg:top-10 top-6 lg:right-10 right-6"><img class="w-auto h-11 w-[45px] object-cover" /></div>
                                                                    <h3 class=" font-bold lg:pb-6 pb-4 text-white text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Web Development</h3>
                                                                    <p class="text-white text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Quickly and cost-effectively validate your custom web product with real customers.</p>
                                                                </a></article>
                                                        </li>
                                                        <li class="splide__slide">
                                                            <article class="relative isolate flex flex-col justify-end overflow-hidden lg:rounded-[30px] rounded-2xl bg-gray-900 lg:px-10 px-6 lg:pb-10 pb-6 pt-48 lg:pt-80 w-full h-full"><a href="../mobile-app-development/index.html"><img src="https://images.ctfassets.net/mi665aivb0at/2lSEefqnYcDAxerXOVo02c/c7cccf38ebec495a057119e8750d87e2/App_Development_.webp" alt="App Development" class="absolute inset-0 -z-10 h-full w-full object-cover" />
                                                                    <div class="black-overlay"></div>
                                                                    <div class="absolute lg:top-10 top-6 lg:right-10 right-6"><img class="w-auto h-11 w-[45px] object-cover" /></div>
                                                                    <h3 class=" font-bold lg:pb-6 pb-4 text-white text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">App Development</h3>
                                                                    <p class="text-white text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Test the waters before committing to full-scale development, gaining a better understanding of what users want.</p>
                                                                </a></article>
                                                        </li>
                                                        <li class="splide__slide">
                                                            <article class="relative isolate flex flex-col justify-end overflow-hidden lg:rounded-[30px] rounded-2xl bg-gray-900 lg:px-10 px-6 lg:pb-10 pb-6 pt-48 lg:pt-80 w-full h-full">
                                                                <div><img src="https://images.ctfassets.net/mi665aivb0at/3nUdBwLmQZ8H2q54PjjeeQ/32a2b9548e8abe713d5ffcd4cb44f28c/Product_Development_.webp" alt="Product Development" class="absolute inset-0 -z-10 h-full w-full object-cover" />
                                                                    <div class="black-overlay"></div>
                                                                    <div class="absolute lg:top-10 top-6 lg:right-10 right-6"><img class="w-auto h-11 w-[45px] object-cover" /></div>
                                                                    <h3 class=" font-bold lg:pb-6 pb-4 text-white text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Product Development</h3>
                                                                    <p class="text-white text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Build an MVP that aligns perfectly with your product vision and consumer demands.</p>
                                                                </div>
                                                            </article>
                                                        </li>
                                                        <li class="splide__slide">
                                                            <article class="relative isolate flex flex-col justify-end overflow-hidden lg:rounded-[30px] rounded-2xl bg-gray-900 lg:px-10 px-6 lg:pb-10 pb-6 pt-48 lg:pt-80 w-full h-full">
                                                                <div><img src="https://images.ctfassets.net/mi665aivb0at/4Grx8ZdpokltP6B2FOAxWP/6eed522b6e093ba551efeefa74d64bbe/Custom_Software_.webp" alt="Custom Software" class="absolute inset-0 -z-10 h-full w-full object-cover" />
                                                                    <div class="black-overlay"></div>
                                                                    <div class="absolute lg:top-10 top-6 lg:right-10 right-6"><img class="w-auto h-11 w-[45px] object-cover" /></div>
                                                                    <h3 class=" font-bold lg:pb-6 pb-4 text-white text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Custom Software</h3>
                                                                    <p class="text-white text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Create digital products that strike the perfect balance between features and user experience.</p>
                                                                </div>
                                                            </article>
                                                        </li>
                                                    </ul>
                                            ...
                                            <ul class="splide__list">
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl"> Use MVPs to quickly validate ideas and bring innovative solutions to market.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl">Test new solutions and improve patient care with our MVP development services.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl">Launch MVPs that enhance the shopping experience and drive sales.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl">Create engaging and effective learning solutions with our MVPs.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl">Develop MVPs that streamline property management and improve customer experience.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                                <li class="splide__slide"><a class="cursor-pointer">
                                                        <article class="bg-gradient-to-r from-[#050505] to-[#201F21] p-6 lg:p-[30px] lg:mx-0 rounded-3xl lg:h-[235px] h-52 flex flex-col justify-between cursor-auto">
                                                            ...
                                                            <div>
                                                                <p class=" !text-[#6F6F6F] text-sm lg:text-md xl:text-lg 2xl:text-xl">Make the overall experience more interactive, competitive, and enjoyable.</p>
                                                            </div>
                                                        </article>
                                                    </a></li>
                                            </ul>
