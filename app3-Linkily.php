...
<head>
  ...
  <title data-gatsby-head="true">Portfolio: Mobile App Linkily | App pulse</title>
</head>
<?php
                    ...
                    <div>
                      <div class="overflow-hidden">
                        <h1
                          ...
                          Linkily - Capturing Life’s Moments, One Post at a Time</h1>
                      </div>

                    </div>
                  </div>
                </div>
              </section><img src="./dist/images/portfolio/03.jpg" loading="lazy" class="w-full" alt="Linkily App" />
                  ...
                  <div class="lg:grid lg:grid-cols-12">
                    <div class="lg:col-span-6">
                      ...
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                        In today’s digital age, social connectivity is more than a trend—it’s a necessity. Our client
                        aspired to create a platform where users can seamlessly share their moments, connect with
                        others, and express their creativity. Their vision was bold: to redefine the way people interact
                        online by fostering a space for sharing joy, inspiration, and authentic connections.<br /><br />
                      </p>
                  ...
                  <div class="flex justify-between flex-wrap">
                    <div class="lg:w-[50%]">
                      <div class="lg:overflow-hidden">
                        <h2
                          class="font-bold pb-6 lg:pb-[2.375rem] sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                          <span>Linkily – Your Space to Share, Connect, and Inspire: </span>
                          <br class="block lg:hidden" /></h2>
                      </div>
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                        Linkily transforms how we experience social media by offering a platform that lets users create
                        accounts, follow friends and influencers, upload posts, and make engaging reels. Whether
                        capturing everyday joys or showcasing creative talents, Linkily ensures every moment is
                        celebrated, shared, and cherished.</p>
                    </div>
                      ...
                      <div class="flex flex-col gap-y-5">
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">We began by
                            diving into what users crave most in a social media platform: intuitive design, engaging
                            features, and opportunities for meaningful interactions. By analyzing existing platforms, we
                            identified areas to innovate, focusing on seamless content creation, enhanced discovery
                            tools, and fostering a supportive online community.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">A detailed
                            review of leading platforms like Instagram and TikTok revealed both their strengths and
                            gaps. While these platforms excel in entertainment, they often lack tools for authentic
                            connection and user-centric customization. With these insights, we designed Linkily to
                            balance creativity and community, prioritizing a user-friendly experience that encourages
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <h3 class=" font-bold my-3 text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Design &amp;
                            Development:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Our creative
                            team meticulously designed a sleek, intuitive interface, ensuring users can effortlessly
                            create and explore content.
                            <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Development
                              highlights include:</p>
                            <ul class="design-list">
                              <li><strong>Profile Management: </strong>Allowing users to set up personalized accounts
                                and curate their online presence. </li>
                              <li><strong>Content Sharing: </strong>Enabling photo and video uploads, reel creation, and
                                creative post editing tools. </li>
                              <li><strong>Engagement Features: </strong>Providing options to follow, like, comment, and
                                share posts with ease. </li>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                            Rigorous testing was conducted to ensure Linkily offers a flawless user experience. By
                            collaborating with beta users, we refined functionalities such as reel uploads, feed
                            customization, and post interactions. Load testing ensured performance consistency, even
                            during peak usage.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          ...
                          <h3 class=" font-bold my-3 text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">
                            Launch &amp; Support:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                            With client approval, Linkily was launched on iOS and Android platforms. Our dedicated
                            support team continues to monitor performance, introduce innovative features like advanced
                            editing tools and AI-driven content recommendations, and ensure the platform evolves
                            alongside user needs.</p>
                        </div>
                      </div>
                    </div>
                  </div>
