          ...
          <div class="undefined relative z-50 ">
            <main>
              <section class="hero-sec pb-0 lg:pb-8">
                ...
                src="./dist/images/portfolio/02.jpg"
                loading="lazy" class="w-full" alt="Jet Sky Surfing App" />
                ...
                <div class="px-6 lg:px-8 pt-14 md:pt-[10.5rem] max-w-7xl mx-auto">
                  <div class="lg:grid lg:grid-cols-12">
                    <div class="lg:col-span-6">
                      ...
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">In the age of immersive gaming, players crave experiences that transcend traditional gameplay and transport them into adrenaline-fueled worlds. Our client envisioned a dynamic platform that captures the thrill of jet skiing, combining competitive gameplay with customizable features to keep users engaged. Their mission was clear: to craft a game that isn’t just played but truly experienced—a celebration of speed, skill, and style.
                        <br /><br /></p>
                ...
                <div class="px-6 lg:px-8 pt-14 md:pt-[10.5rem] max-w-7xl mx-auto lg:pb-24 pb-8">
                  <div class="flex justify-between flex-wrap">
                    <div class="lg:w-[50%]">
                      ...
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Jet Sky Surfing redefines mobile gaming by delivering a fast-paced, water adventure that puts players in control of sleek jet skis. Featuring breathtaking courses, customizable skins, and competitive leaderboards, Jet Sky Surfing ensures every ride is exhilarating and every player feels like a champion.</p>
                    </div>
                    ...
                    <div class="lg:col-span-6">
                      <div class="flex flex-col gap-y-5">
                        <div style="background:#F1F1F1"
                          ...
                          Ideation:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">We began by diving into the minds of gaming enthusiasts. What do they want from a jet-skiing game? Speed, excitement, customization, and competition topped the list. We identified a need for dynamic gameplay, offering unique challenges and endless personalization to keep players hooked.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">We studied popular water-themed games and racing titles, identifying strengths and shortcomings. While competitors offered exciting visuals and competitive gameplay, many lacked the depth of customization and player engagement. Inspired to fill this gap, we designed Jet Sky Surfing as a holistic experience blending adrenaline-pumping races with endless personalization options.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <h3 class=" font-bold my-3 text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">Design &amp;
                            Development:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Our design team created a visually stunning interface, ensuring an intuitive and immersive player journey. Key features include:
<ul class="design-list">
  <li><strong>	Customizable Jet Skis:</strong> Unlock and purchase unique skins and upgrades to showcase your style.</li>
  <li><strong>Dynamic Racing Tracks: </strong>Ride through thrilling courses with varying difficulty levels, obstacles, and breathtaking environments.</li>
  <li><strong>Competitive Gameplay: </strong>Climb leaderboards, compete in tournaments, and challenge friends to become the ultimate wave rider.</li>
  <li><strong>Progressive Unlocks: </strong>Win races to earn coins, unlock rare skins, and upgrade your jet ski for enhanced performance.</li>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">We rigorously tested Jet Sky Surfing across devices to ensure flawless gameplay. With inputs from beta testers, we fine-tuned controls, enhanced graphics, and optimized performance for seamless enjoyment, whether on calm waters or stormy seas.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <h3 class=" font-bold my-3 text-2xl xl:text-3xl 2xl:text-4xl tracking-[0px]">
                          Launch  &amp; Support:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">With the client’s approval, Jet Sky Surfing launched globally on iOS and Android platforms. Our support team remains committed to delivering regular updates, introducing new tracks, skins, and seasonal events to keep the gameplay fresh and exciting.</p>
                        </div>
                      </div>
                    </div>
                  </div>
