...
<head>
  ...
  <title data-gatsby-head="true">Portfolio: Mobile App InTune | App pulse</title>
</head>
<?php
          ...
          <div class="undefined relative z-50 ">
            <main>
              <section class="hero-sec pb-0 lg:pb-8">
                    ...
                    <div>
                      <div class="overflow-hidden">
                        <h1
                          ...
                          InTune – Bringing Harmony to Your Fingertips</h1>
                      </div>
                ...
                src="./dist/images/portfolio/05.jpg"
                loading="lazy" class="w-full" alt="InTune App" />
                ...
                <div class="px-6 lg:px-8 pt-14 md:pt-[10.5rem] max-w-7xl mx-auto">
                  <div class="lg:grid lg:grid-cols-12">
                    <div class="lg:col-span-6">
                      ...
                      In a world where music connects hearts and transcends boundaries, our client aspired to create a platform that transforms how users experience and engage with music. Their vision was to provide an app that not only delivers access to millions of tracks but also curates a personalized musical journey, ensuring every note resonates with joy and inspiration.<br /><br /></p>
                  ...
                  <div class="flex justify-between flex-wrap">
                    <div class="lg:w-[50%]">
                      <div class="lg:overflow-hidden">
                        <h2
                          class="font-bold pb-6 lg:pb-[2.375rem] sentence-first-letter text-4xl xl:text-5xl 2xl:text-6xl tracking-[-2px] lg:-translate-y-[7px] xl:!leading-[55px] 2xl:!leading-[65px]">
                          <span>InTune – Your Gateway to Global Melodies: </span>
                          <br class="block lg:hidden" /></h2>
                      </div>
                      <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                      InTune revolutionizes music streaming by offering users a seamless way to explore, enjoy, and feel the rhythm of life. From chart-topping hits to hidden gems from every corner of the globe, InTune brings a world of sound to your fingertips. Whether you're looking to energize your mornings, relax after a long day, or discover a new favorite artist, InTune ensures every moment is enriched with the perfect soundtrack.</p>
                    </div>
                    ...
                    <div class="lg:col-span-6">
                      <div class="flex flex-col gap-y-5">
                        <div style="background:#F1F1F1"
                          ...
                          Ideation:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          We started by delving into what music enthusiasts value most: variety, quality, discoverability, and effortless navigation. Through detailed research and user insights, we pinpointed opportunities to enhance the listening experience by incorporating intelligent song recommendations, genre-based explorations, and seamless playlist curation.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Analyzing popular platforms like Spotify and Apple Music, we identified areas where users felt underserved—such as limited music discovery options, less intuitive interfaces, and generic recommendations. Inspired by these insights, we designed InTune to go beyond streaming, offering users a deeply personalized and joyful listening journey.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img />
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">Our design team harmonized form and function, crafting an intuitive interface that lets users dive into their favorite tracks or explore new ones effortlessly. The development process focused on:</p>
                          <ul class="design-list">
  <li><strong>User Features:</strong> Allowing users to search global music libraries, create and share playlists, and enjoy music with adaptive sound quality. </li>
  <li><strong>Personalized Recommendations:</strong> Utilizing AI to suggest tracks based on listening habits, mood, and trending songs globally.</li>
  <li><strong>Community Engagement:</strong> Integrating social features for users to follow friends, share playlists, and connect over mutual tastes.</li>
                        ...
                        <div style="background:#F1F1F1"
                          ...
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          To ensure flawless functionality, InTune was tested in diverse scenarios, including high-traffic usage, offline streaming modes, and cross-platform synchronization. Collaborating with music curators and beta users, we refined features to deliver an immersive and reliable experience.</p>
                        </div>
                        <div style="background:#F1F1F1"
                          class="theProcess px-7 pt-9 pb-7 lg:rounded-[30px] rounded-2xl darkBg">
                          <img /><span
                          ...
                          Launch  &amp; Support:</h3>
                          <p class="text-black text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                          After extensive testing and optimization, InTune debuted on iOS and Android, delighting users worldwide. Our dedicated support team continues to monitor the app, roll out updates, and introduce innovative features like mood-based playlists, immersive soundscapes, and enhanced sharing options to keep users coming back for more.</p>
                        </div>
                      </div>
                    </div>
                  </div>
